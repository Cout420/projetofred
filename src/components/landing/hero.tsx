...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative h-[90vh] w-full min-h-[700px] flex items-center justify-center text-white">
      ...
      <div ref={ref} style={style} className="relative container mx-auto px-4 md:px-6 z-10 flex flex-col items-center text-center">
